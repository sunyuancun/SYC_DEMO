...
public class QQCommentActivity extends Activity {
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void inputComment(final View v, User receiver) {
        CommentFun.inputComment(QQCommentActivity.this, mListView, v, receiver, new CommentFun.InputCommentListener() {
            @Override
